...
export const StreetList = memo(function StreetList({
  lang,
  streets,
  guessedCount,
}: StreetListProps) {
    ...
    >
      ...
      <div
        style={{
          ...
          borderBottom: "1px solid rgba(66,48,35,0.1)",
      ...
      >
        <span>
          {t.unlockedStreets} ({guessed})
        </span>
        <span style={{ color: "#8a7a65" }}>
          {t.streetCount.replace("{total}", String(total))}
        </span>
      </div>
