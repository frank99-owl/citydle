...
export function TutorialOverlay({
  ...
  const stepIcons = [
    ...
    <svg key="welcome" viewBox="0 0 64 64" style={{ width: 56, height: 56 }}>
      ...
      <polygon
        points="32,52 29,34 32,30 35,34"
        fill="currentColor"
        opacity={0.5}
      />
      <polygon
        points="12,32 30,29 34,32 30,35"
        fill="currentColor"
        opacity={0.5}
      />
    ...
    <svg key="hints" viewBox="0 0 64 64" style={{ width: 56, height: 56 }}>
      <path
        d="M32 8 C22 8 14 16 14 26 C14 33 18 37 22 40 L22 46 L42 46 L42 40 C46 37 50 33 50 26 C50 16 42 8 32 8Z"
        fill="none"
        stroke="currentColor"
        strokeWidth="1.5"
      />
    ...
    >
      ...
      {["top-left", "top-right", "bottom-left", "bottom-right"].map((pos) => (
        <div
          ...
          style={{
            ...
            borderRadius: pos.includes("top-left")
              ? "50% 0 0 0"
      ...
      <div
        ...
        style={{
          position: "relative",
          background:
            "linear-gradient(145deg, #f4ebd0 0%, #e6dfc7 40%, #d8ceb0 100%)",
          border: "2px solid #423023",
          borderRadius: "6px",
          boxShadow:
            "0 20px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(197,160,89,0.2), inset 0 0 20px rgba(44,37,25,0.08)",
          ...
          {Array.from({ length: totalSteps }).map((_, i) => (
            <div
              ...
              style={{
                ...
                borderRadius: "4px",
                background:
                  i === currentStep ? "#c5a059" : "rgba(78,54,41,0.2)",
