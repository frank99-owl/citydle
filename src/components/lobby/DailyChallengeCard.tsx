...
export const DailyChallengeCard = memo(function DailyChallengeCard({
  ...
  return (
    <div style={{
      ...
      zIndex: 1,
      marginBottom: '1.5rem',
      background: 'linear-gradient(135deg, rgba(197,160,89,0.12) 0%, rgba(138,51,36,0.08) 100%)',
      ...
      <div style={{
        ...
        width: '60px',
        height: '60px',
        background: 'linear-gradient(225deg, rgba(197,160,89,0.2) 0%, transparent 70%)',
        pointerEvents: 'none',
      }} />
      ...
      <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
            ...
            <div>
              <div style={{
                ...
                {lang === 'zh' ? dailyChallenge.cityName : dailyChallenge.cityNameEn}
              </div>
              <div style={{
                fontSize: '0.8rem',
        ...
        {/* Right: Action / Result */}
        <div style={{ flex: '0 0 auto', textAlign: 'center', minWidth: '140px' }}>
          {isCompletedToday && todayResult ? (
            <div>
              ...
              <div style={{ fontSize: '0.8rem', color: 'rgba(244,235,208,0.6)' }}>
                {todayResult.score}/{todayResult.totalStreets} 🔥{todayResult.maxStreak}
              </div>
            </div>
          ) : (
            <button
              onClick={() => onStartChallenge(dailyChallenge.presetIndex, dailyChallenge.difficulty)}
              style={{
                fontFamily: 'var(--font-cinzel), serif',
                fontSize: '0.85rem',
                letterSpacing: '0.1em',
