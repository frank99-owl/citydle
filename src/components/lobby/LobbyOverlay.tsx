...
const AchievementPanel = dynamic(
  () =>
    import("@/components/achievement/AchievementPanel").then((m) => ({
      default: m.AchievementPanel,
    })),
  { ssr: false },
);
const StatsPanel = dynamic(
  () =>
    import("@/components/stats/StatsPanel").then((m) => ({
...
const Leaderboard = dynamic(
  () =>
    import("@/components/leaderboard/Leaderboard").then((m) => ({
...
export function LobbyOverlay({
  ...
  const [activeTab, setActiveTab] = useState<
    "history" | "favorites" | "achievements" | "stats" | "leaderboard"
  >("history");
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          {activeTab === "history" && (
            <HistoryTable history={history} lang={lang} />
          )}
          {activeTab === "favorites" && (
            <FavoritesList
              favorites={favorites}
          ...
          {activeTab === "achievements" && (
            <AchievementPanel
              lang={lang}
              isVisible={activeTab === "achievements"}
            />
          )}
          {activeTab === "stats" && (
            <StatsPanel
