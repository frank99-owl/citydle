...
export const PresetCards = memo(function PresetCards({
  presets,
  lang,
  onSelect,
  onCustom,
        ...
        {presets.map((preset) => {
          ...
          return (
            <button
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(244,235,208,0.08) 0%, rgba(197,160,89,0.05) 100%)",
              ...
              onMouseEnter={(e) => {
                ...
                (e.currentTarget as HTMLButtonElement).style.boxShadow =
                  "0 12px 30px rgba(197,160,89,0.2)";
              }}
              onMouseLeave={(e) => {
                (e.currentTarget as HTMLButtonElement).style.background =
                  "linear-gradient(135deg, rgba(244,235,208,0.08) 0%, rgba(197,160,89,0.05) 100%)";
