...
import {
  ...
  Street, HintClue, Achievement, GameResult, Preset, GuessResult,
} from '@/types';
...
interface GameContextValue {
  ...
  clearHint: () => void;
  clearAllLayers: () => void;
  setupDrawing: (enabled: boolean, onDraw: (bounds: Bounds) => void, mapProvider: MapProvider) => void;
  syncTileLayer: (url: string, options: Record<string, any>) => void;
  shiftMapCenter: (oldProvider: string, newProvider: string, convertFn: (lat: number, lng: number, oldP: string, newP: string) => [number, number]) => void;
  loading: boolean;
